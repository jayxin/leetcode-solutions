...
// 3228. 将 1 移动到末尾的最大操作次数 - 给你一个 二进制字符串 s。
...
//  * 1 <= s.length <= 105
//  * s[i] 为 '0' 或 '1'。
// 1. It is optimal to perform the operation on the lowest index possible each
// time.
// 2. Traverse the string from left to right and perform the operation every
// time it is possible.
